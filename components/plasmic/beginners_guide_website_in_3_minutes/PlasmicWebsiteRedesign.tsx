...
import sty from "./PlasmicWebsiteRedesign.module.css"; // plasmic-import: V-2G-locadxw/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section__tdeti)}
            id={"Services"}
          >
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img___8U2Xy)}
              displayHeight={"700px"}
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section___3HUaj)}
            id={"work"}
          >
            <div className={classNames(projectcss.all, sty.freeBox__wFSn)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox___5IdPu)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__qCdT)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__mszba)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__nztjJ)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img___9TG9P)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
                ...
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.columns___9YkKk)}
                >
                  <div
                    className={classNames(projectcss.all, sty.column__imJNk)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__n53V)}
                      displayHeight={
                  ...
                  <div
                    className={classNames(projectcss.all, sty.column__hYGkO)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img___3WWwX)}
                      displayHeight={
                        hasVariant(globalVariants, "screen", "mobileOnly")
                          ? "300px"
                          : "600px"
              ...
              <div className={classNames(projectcss.all, sty.freeBox__yOjMy)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__lqYyC)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox___4EOll)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__krYlu)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              <div className={classNames(projectcss.all, sty.freeBox__amFFr)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__wFSw)}
              id={"contact"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__otMM)}>
                <h2
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.columns__iEf3U)}
              >
                <div className={classNames(projectcss.all, sty.column__zutMm)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__oDcHl
                    )}
                    image={{
                ...
                <div className={classNames(projectcss.all, sty.column__hmV3D)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__dDCs
                    )}

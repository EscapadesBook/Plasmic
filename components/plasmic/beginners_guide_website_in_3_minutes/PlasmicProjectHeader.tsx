...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: 9o8k8vtcaScQ/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__fRe92)}>
        <div className={classNames(projectcss.all, sty.column__cHxYw)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__ba6Vj)}>
          <div className={classNames(projectcss.all, sty.columns__vGtBo)}>
            <div className={classNames(projectcss.all, sty.column__vX7Y2)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox___5RHsI)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__hcimp)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox___2BvwD)}>
                {renderPlasmicSlot({
